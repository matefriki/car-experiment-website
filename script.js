...
window.addEventListener('load',
    () => {
        ...
        console.assert(pixi.screen.width === 150, "The screen width does not match!");
        ...
        pixi.stage.addChild(person);
        pixi.stage.addChild(car);
        pixi.stage.addChild(block);
        pixi.stage.addChild(bottom_corner);
        pixi.stage.addChild(top_corner);
...
function adjustBlock() {
    ...
    let top = pixi.stage.getChildByName("top_corner");
    let bottom = pixi.stage.getChildByName("bottom_corner");
    let block = pixi.stage.getChildByName("block")
...
function adjustVisibilityLine(visible) {
    let car = pixi.stage.getChildByName("car");
    let person = pixi.stage.getChildByName("person");
    let line = pixi.stage.getChildByName("visibility_line");
...
function performChanges(inp) {
    ...
    if (!obj_name) return;
    let obj = pixi.stage.getChildByName(obj_name);
